...
!["График, построенный на языке Open Modelica"](image/4.png){#fig:004 width=90% height=90%}
...
!["График, построенный на языке Open Modelica"](image/5.png){#fig:005 width=90% height=90%}
