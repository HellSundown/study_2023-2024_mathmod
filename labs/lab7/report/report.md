...
Код программы для второго случая $\frac{dn}{dt} = (0.000075 + 0.25n(t))(N-n(t))$:
...
Код программы для третьего случая $\frac{dn}{dt} = (0.25\sin{t} + 0.75t  n(t))(N-n(t))$:
