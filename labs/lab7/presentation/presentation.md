...
## Задание лабораторной работы. Вариант 38
...
## Результаты работы кода на Julia и Open Modelica для первого случая $\frac{dn}{dt} = (0.25 + 0.000075n(t))(N-n(t))$:
...
## Результаты работы кода на Julia и Open Modelica для случая $\frac{dn}{dt} = (0.000075 + 0.25n(t))(N-n(t))$:
...
## Результаты работы кода на Julia и Open Modelica для случая $\frac{dn}{dt} = (0.25\sin{t} + 0.75t n(t))(N-n(t))$:
