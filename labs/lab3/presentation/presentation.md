...
## Задание лабораторной работы. Вариант 28
...
На рис. [-@fig:001] изображён итоговый график.

!["Полученный график Julia. Первый случай"](image/1.png){#fig:001 width=50%}

## Результаты работы кода на Julia

На рис. [-@fig:002] изображён итоговый график.

!["Полученный график Julia. Второй случай"](image/2.png){#fig:002 width=50%}
...
!["Полученный график OpenModelica. Первый случай"](image/3.png){#fig:003 width=70%}

## Результаты работы кода на OpenModelica

На графиках на рис. [-@fig:003] и [-@fig:004], построенных с помощью OpenModelica изображены графики, аналогичные графикам [-@fig:001] и [-@fig:002] соответственно.

!["Полученный график OpenModelica. Второй случай"](image/4.png){#fig:004 width=70%}
